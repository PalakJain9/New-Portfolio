  ...
  return (
    <div className='relative z-30 w-full h-[100vh] bg-darkBlue flex grow glow flex-col justify-center items-start overflow-hidden'>
      ...
      >
        ...
        >
          Hey, I'm Palak, a full stack developer and a proud henna artist. Using my development experience to build amazing products for the . I help companies make user friendly and scalable software.
        </p>
      </div>
    </div>
    </div>
